    ...
    <div className="space-y-10">
      ...
      <div className="h-full overflow-y-auto p-4">
        <ul className="space-y-4">
          {!events.length && (
            <li key="waiting" className="flex">
              <div className="flex gap-2 text-right max-w-xs ml-auto">
                <p className="bg-neutral-700 text-white p-4 rounded-xl animate-pulse">
                  ...
                </p>
              </div>
            </li>
          ...
          {loading.isLoading && (
            <li key="loading" className="flex">
              <div className="flex gap-2 text-right max-w-xs ml-auto">
                <p
                  className={`${
                    loading.track === "agent" ? "bg-neutral-700" : "bg-blue-500"
                  } text-white p-4 rounded-xl animate-pulse`}
                >
                  ...
                </p>
              </div>
